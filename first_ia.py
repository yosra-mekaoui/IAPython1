#bibliotheque permet la gestion des matrices
#pip3 install numpy
import numpy as np
...
class Neural_Network(object):
    def __init__(self):
        ...
        self.W2 = np.random.randn(self.hiddenSize, self.outputSize) #Matrice 2x3
    #permet de multiplier notre valeur d'entrée par le poids
    def forward(self,X):
